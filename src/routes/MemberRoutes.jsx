    ...
    return (
        <div className="pt-3">
          <Routes>
                ...
                {/* <Route path="/diagnoses/:diagnosisId" element={<DiagnosisUpdate/>}/> */}
                ...
                {/* <Route path="/insurance/:doctorId" element={<InsuranceUpdate/>}/> */}
                <Route path="/meds" element={<Meds/>}/>
                <Route path="/meds/add" element={<MedNew getDate={getDate}/>}/>
                {/* <Route path="/meds/:doctorId" element={<MedUpdate/>}/> */}
                <Route path="/symptoms" element={<Symptoms/>}/>
                <Route path="/symptoms/add" element={<SymptomNew getDate={getDate}/>}/>
                {/* <Route path="/symptoms/:doctorId" element={<SymptomUpdate/>}/> */}
                <Route path="/visits" element={<Visits/>}/>
                 <Route path="/visits/add" element={<VisitNew />}/>
                {/* <Route path="/visits/:doctorId" element={<VisitUpdate/>}/> */}
